...
mixin _$HomeController on _HomeControllerBase, Store {
  Computed<ObservableList<ItemModel>> _$listFiltredComputed;

  @override
  ObservableList<ItemModel> get listFiltred => (_$listFiltredComputed ??=
          Computed<ObservableList<ItemModel>>(() => super.listFiltred))
      .value;
  Computed<int> _$totalChecjdComputed;

  @override
  int get totalChecjd =>
      (_$totalChecjdComputed ??= Computed<int>(() => super.totalChecjd)).value;
  ...
  String toString() {
    final string =
        'listItems: ${listItems.toString()},filter: ${filter.toString()},listFiltred: ${listFiltred.toString()},totalChecjd: ${totalChecjd.toString()}';
    return '{$string}';
  }
}
